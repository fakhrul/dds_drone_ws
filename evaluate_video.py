...
# PATH_TO_CKPT = os.getcwd() + "/trained-inference-graphs/output/checkpoint/"

working_dir =  os.getcwd() + "\\exported-models\\"
print(working_dir)
working_dir = working_dir + os.listdir(working_dir)[len(os.listdir(working_dir)) -1]
print(working_dir)
working__model_dir = working_dir + "\\model\\"


# PATH_TO_CKPT = os.getcwd() + "/exported-models/my_model/checkpoint/"
# PATH_TO_CFG = os.getcwd() + '/exported-models/my_model/pipeline.config'
...
# cap = cv2.VideoCapture('C:/DDS_DATA_SET/VIDEO/20230414_20340101100407_20340101100800_144539.mp4')
# cap = cv2.VideoCapture('C:/DDS_DATA_SET/VIDEO/diy_new_video/diy_bellon.mp4')
# cap = cv2.VideoCapture('C:/DDS_DATA_SET/VIDEO/02_01.mp4') # ada burung detect as mavic2
# VIDEO_FOLDER = 'C:/DDS_DATA_SET/VIDEO/'
VIDEO_FOLDER = 'C:/Github/dds_drone_ws/workspace/training_dds/'
# VIDEO_FOLDER = 'C:/DDS_DATA_SET/penjara_20230807/videos/'

VIDEO_FILE_NAME = 'VIDEO_MAVIC2_FOR_EVALUATE'
# VIDEO_FILE_NAME = '20230707112029'
VIDEO_FILE_EXT = '.mp4'
VIDEO_FULL_PATH = VIDEO_FOLDER + VIDEO_FILE_NAME + VIDEO_FILE_EXT
...
file_name = VIDEO_FILE_NAME + "_processed_{:%Y%m%dT%H%M%S}.avi".format(datetime.datetime.now())
...
while True:
    ...
    # Display output
    cv2.imshow('object detection', splash)
